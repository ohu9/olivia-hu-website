...
export default function Page() {
	return (
		<div className="flex bg-zinc-50">
			<div className="mx-auto mt-[25vh] bg-[#EEE9E2] p-14 rounded-2xl leading-9 text-center">
				Hello! This site has been moved to{' '}
				<Link
					href="https://www.olivia-hu.com"
					className="underline"
				>www.olivia-hu.com</Link>.<br/>
				Please continue along to link! thanks :)
			</div>
		</div>
	)
	// return (
